...
def multi_class_model(X_train, Y_train, X_test, Y_test, num_iterations = 500, learning_rate = 0.25, print_cost = False):
    np.random.seed(23)
    grads = {}
...
nnModel = multi_class_model(X_train, y_train,X_test,y_test,500,0.25,True)
plot_loss(nnModel["costs_train"],nnModel["costs_test"])